...
export default function ScoresParallel() {
  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-4 right-4 bg-indigo-600 text-white p-3 rounded-full shadow-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 z-10"
